...
const RainbowButton = React.forwardRef<HTMLAnchorElement, RainbowButtonProps>(
  ({ className, children, href, ...props }, ref) => {
    return (
      <a
        className="group relative inline-block cursor-pointer rounded-full bg-slate-800 p-px text-sm font-semibold leading-6 text-white no-underline  shadow-2xl shadow-zinc-900"
        href={href || "#"}
        ref={ref}
        {...props}
      >
